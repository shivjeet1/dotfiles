...
def process_image(file_path):
    # Preprocess the image before passing to OCR
    preprocessed_image = preprocess.preprocess_image(file_path)
    text = ocr_engine.extract_text(preprocessed_image)
    return text
...
class OCRApp(QWidget):
    ...
    def process_image(self, file_path):
        ...
        if text.strip():
            ...
            self.ocr_result.setText("No text detected. Try adjusting the image clarity or contrast.")
