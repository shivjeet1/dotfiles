...
class OCRApp(QWidget):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Secure-OCR")
        ...
        self.select_button.setStyleSheet("background-color: #444; padding: 8px; alignment: center;")
        ...
        self.text_heading.setStyleSheet("font-size: 20px; font-weight: bold;")
        ...
        self.format_selector.setStyleSheet("background-color: #444; padding: 5px; font-size: 12px; color: white;")
