...
class OCRApp(QWidget):
    def __init__(self):
        ...
        self.select_button.setStyleSheet("background-color: #444; padding: 8px; font-size: 14px;")
        self.select_button.setFixedSize(200, 40)
        self.select_button.clicked.connect(self.load_image)
        self.left_panel.setSpacing(50)
        ...
        self.text_heading.setStyleSheet("font-size: 16px; font-weight: bold; font-size: 14px;")
